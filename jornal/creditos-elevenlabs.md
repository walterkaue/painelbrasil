...
pra 9.314 no primeiro teste). Voz usada nas duas primeiras edições: Roger (Laid-Back, Casual,
Resonant) — 49s pro Salesforce (~14 car./s), 67s pro Mercado (~12 car./s) — ritmo de fala varia um
pouco por texto, não é constante.

**Primeira semana completa: 1.461 caracteres pros dois cadernos**, dentro da meta de ~1.400-1.800
do plano.

**07/09/2026 — primeira semana do teste de vozes (issue #12):** voz **Guga (Diplomatic and
Intimidating)** nos dois cadernos — 53s pro Salesforce (662 caracteres, ~12,5 car./s), 59s pro
Mercado (656 caracteres, ~11,1 car./s). Ritmo mais lento que o Roger, o que já era esperado por ser
um estilo de voz diferente (mais grave/pausado, "diplomático").
